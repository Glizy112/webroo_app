...
const DetailForm = ({ formInModal, availableSports, courtData, facilitySports, routedData}) => {
  const [selectedDate, setSelectedDate] = useState(routedData ? routedData.date : '');
  const [selectedTime, setSelectedTime] = useState(routedData ? routedData.from : '');
  const [selectedSport, setSelectedSport] = useState(routedData ? routedData.selectedSports : '');
          ...
          <div className='col-12'>
            <div className='d-flex align-items-center' style={{ borderWidth: 2, borderColor: 'rgba(152, 181, 255, 0.3)', borderStyle: 'solid', borderRadius: 60, paddingLeft: 24, paddingTop: 4, paddingBottom: 4 }}>
              ...
              <div className='w-100'>
                ...
                <DatePicker className="datePicker" format="YYYY-MM-DD" style={datePick} defaultValue={moment(routedData?.date)} onChange={(value, dateString) => handleDateChange(dateString)} />
              </div>
            </div>
              ...
              <div className='d-flex align-items-center mt-3 ml-3' style={{ borderWidth: 2, borderColor: 'rgba(152, 181, 255, 0.3)', width: '98%', borderStyle: 'solid', borderRadius: 60, paddingLeft: 18, paddingTop: 4, paddingBottom: 4 }}>
                ...
                <div className='w-100 d-flex flex-column'>
                  ...
                  <Sel
                    ...
                    className="timeSelect1"
                    suffixIcon={""}
                    value={routedData!==undefined && routedData.to}
                    style={{zIndex: 999999}}
              ...
              <SelectSportIcon />
                <div className='w-100 d-flex flex-column'>
                  ...
                  <Sel
                    ...
                    className="timeSelect1"
                    suffixIcon={""}
                    value={routedData!==undefined && routedData.selectedSports}
