        ...
        >
            ...
            <div className='card_detail_section'>
                <div className='d-flex py-3 px-2 mx-1 mt-2 justify-content-between'>
                    ...
                    <div className='float-right mr-1 p-3' style={{zIndex: 999}} onClick={() => {setIsVisible(!isVisible); setClickedIndex(itemKey)}}>
                        <MoreIcon />
                    </div>
                    <div className='dropdown__container' 
                         style={{ display: isVisible === true && itemKey === court?.id
                                  //(isCourtCard ? itemKey === court?.id : itemKey===facility?.id)) 
                                  ? 'block' 
                                  : 'none' 
                          }}
                    >
