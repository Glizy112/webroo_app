  ...
  return (
    <>
      <div className="index-search-box-no-padding d-flex">
        <div
          className={`search-form-row d-flex ${
            isHorizontal ? "" : ""
          } align-items-center ${isHorizontal ? "w-100" : ""}`}
        >
          <div
            className={`search-form-item sport-form-item ${
              isHorizontal ? (isDate ? "select__sports__dropdown" : "") : ""
              ...
              <>
                <Input
                  ...
                  className={`form-control ${
                    isHorizontal && isDate ? "search-select" : "bg-white"
                  }`}
                  name="location"
          ...
          {isDate && (
            ...
            >
              <div onClick={handleSearch}>
                ...
                <a
                  className={`btn-search mobile-search ${
                    isHorizontal ? "" : ""
                  } `}
                >
