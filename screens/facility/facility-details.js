...
const FacilityDetail = () => {
  ...
  // console.log("Passed Data to Details-> ", decodeURIComponent(detailFormData))
  ...
  useEffect(()=> {
    ...
    if(data) {
    //const routedFormData = JSON.parse(detailFormData);
    console.log("Search Data-> ", JSON.parse(data));
    setRoutedData(JSON.parse(data));
    }
      ...
      <div className="container py-4" style={{marginTop: 72}}>
        ...
        <div className="row">
          ...
          <div className="col-md-4 side__details__content d-none d-md-none d-sm-none d-lg-block">  
            ...
            <DetailForm availableSports={sports} courtData={courts} facilitySports={facility?.sports} routedData={routedData}/>
          </div>
